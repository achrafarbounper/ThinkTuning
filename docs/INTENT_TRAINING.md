...
> **Statut (septembre 2026)** — Pipeline backend actif consommé via
> `/api/v1/train/intent*` et WebSocket/SSE versionnés. Les chemins sans préfixe
> sont des références historiques de migration. — Architecture technique
...
> Le contrat frontend/API versionné (`/api/v1/train/intent/...`) est respecté.
