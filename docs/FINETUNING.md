...
> **Statut (septembre 2026)** — Pipeline ML backend actif (PyTorch CPU,
> Transformers, ONNX Runtime optionnel) ; les étapes « phase », « réalisé » ou
> « restant » sont historiques/backlog lorsqu'elles sont ainsi titrées.
