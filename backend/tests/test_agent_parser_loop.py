...
def test_loop_self_corrects_unknown_tool_then_displays_content(sandbox_root):
    ...
    from app.infrastructure.tools.file_tools import write_file
...
def test_loop_reprompts_when_tool_announced_without_any_json(sandbox_root, monkeypatch):
    ...
    import app.infrastructure.tools.tool_registry as registry
    from app.agent.legacy.agent_core import AgentCore
...
def test_system_prompt_lists_every_registered_tool():
    from app.agent.legacy.system_prompt import build_system_prompt
