"""
Rétention des jobs : purge des jobs terminés obsolètes (app.infrastructure.persistence.job_store.cleanup_old_jobs).
...
from app.infrastructure.persistence.job_store import PersistentJobStore, cleanup_old_jobs
