...
Couvre :
    ...
    - app.application.agent_cache : sélection du provider par AGENT_PROVIDER,
...
from app.application import agent_cache  # noqa: E402
from app.infrastructure.persistence import agent_settings as agent_settings_module  # noqa: E402
...
# --- app.application.agent_cache : configuration et fabrique --------------------------------------
...
# --- app.application.agent_cache.list_llm_models côté OpenRouter ----------------------------------
