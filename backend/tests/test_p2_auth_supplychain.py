...
def test_model_signature_write_and_verify(tmp_path) -> None:
    from app.legacy.core.model_signing import verify_model_signature, write_signature_manifest
...
def test_model_signature_tamper_detected(tmp_path) -> None:
    from app.legacy.core.model_signing import (
        ModelSignatureError,
...
def test_model_signature_required_policy(tmp_path, monkeypatch) -> None:
    from app.legacy.core.model_signing import ModelSignatureError, verify_model_signature
