...
def approval_store(monkeypatch):
    """Monkeypatche ``app.infrastructure.persistence.approval_store.get_approval_store`` (lazy import)."""
    ...
    from app.infrastructure.persistence import approval_store as approval_store_module
