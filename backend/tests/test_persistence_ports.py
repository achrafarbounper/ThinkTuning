...
def test_default_factories_delegate_to_shared_singletons():
    ...
    from app.infrastructure.persistence.approval_store import get_approval_store as legacy_approvals
    from app.infrastructure.persistence.run_store import get_run_store as legacy_runs
