...
Couvre :
    ...
    - app.application.agent_cache.agent_config : défaut 2048 et surcharge via env
      AGENT_CONTEXT_LENGTH ;
    - app.application.agent_cache._build_runner : le contexte est bien transmis au LLMClient.
