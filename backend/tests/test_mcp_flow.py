...
d'ACTION crée une session du journal « Agent Flow Map » (``core/flow_store``,
...
from core import flow_store as fs
...
def test_flow_non_blocking_when_store_fails(monkeypatch):
    ...
    # Les hooks flow résolvent le store en paresseux (``from core.flow_store
