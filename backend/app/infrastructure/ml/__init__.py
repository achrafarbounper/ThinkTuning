...
Les adaptateurs délègent au legacy (``app.legacy.core.predictor_cache``,
``app.legacy.core.model_versioning``, ``src.inference.predictor``) par attribut de
MODULE (jamais import « par valeur ») : les monkeypatchs des tests
(``monkeypatch.setattr("app.legacy.core.model_versioning.MODEL_ROOT", ...)``) et les
