...
L'agent IA réel (paquet `ia/`, exposé via `app.application.agent_cache`) tourne dans un
...
class ChatRequest(BaseModel):
    ...
    session_id: str | None = Field(
        None,
        description=(
            "Session de conversation (app/infrastructure/persistence/session_store) où journaliser "
...
def list_available_llm_models(_: bool = Depends(require_api_key)) -> dict:
    ...
    502/504 par ``app.application.agent_cache.list_llm_models``.
    """
