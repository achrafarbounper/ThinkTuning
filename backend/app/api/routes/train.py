...
from app.application.trainer_runner import cancel_training, run_training
...
from app.infrastructure.persistence.training_events import (
    ACTIVE_POLL_SECONDS,
    STALL_MINUTES,
...
# L'Event d'annulation vit uniquement dans app.application.trainer_runner
...
def start_training(req: TrainRequest, _: bool = Depends(require_api_key)):
    ...
    # la surface v1 (app.application.training_gate) — un seul plafond pour les deux routes.
