...
async def lifespan(_app: FastAPI):
    ...
    from app.infrastructure.persistence.store_crypto import ensure_store_crypto_configured
...
from app.application.scheduler import ensure_scheduler_started  # noqa: E402
